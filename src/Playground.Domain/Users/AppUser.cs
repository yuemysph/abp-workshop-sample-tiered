...
namespace Playground.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PlaygroundDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PlaygroundEfCoreEntityExtensionMappings to extend the IdentityUser entity
