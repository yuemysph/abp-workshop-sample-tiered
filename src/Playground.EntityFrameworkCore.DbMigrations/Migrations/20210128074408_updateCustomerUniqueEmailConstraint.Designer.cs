...
{
    [DbContext(typeof(PlaygroundMigrationsDbContext))]
    [Migration("20210128074408_updateCustomerUniqueEmailConstraint")]
    partial class updateCustomerUniqueEmailConstraint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Playground.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Playground.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Playground.Books.RentalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppRentalRecords");
                });

            modelBuilder.Entity("Playground.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Playground.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Playground.Books.Book", b =>
                {
                    b.HasOne("Playground.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Playground.Books.RentalRecord", b =>
                {
                    b.HasOne("Playground.Books.Book", null)
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Playground.Customers.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Playground.Payments.Payment", null)
                        .WithMany()
