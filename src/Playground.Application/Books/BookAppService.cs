...
{
    [Authorize(PlaygroundPermissions.Books.Default)]
         ...
         IBookAppService //implement the IBookAppService
    {
        ...
        public BookAppService(IRepository<Book, Guid> repository,
            ...
            : base(repository)
        {
            GetPolicyName = PlaygroundPermissions.Books.Default;
            GetListPolicyName = PlaygroundPermissions.Books.Default;
            CreatePolicyName = PlaygroundPermissions.Books.Create;
        ...
        public string DoSomethingElse(Guid guid)
        {
            return "hello world";
        }
